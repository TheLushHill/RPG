 ...
 * @type number
 * @min 0
 * @desc 当此 ID 的开关为开时，玩家将移动改为四方向
 * If set 0, it's always 8-dir.
 * @default 100
 *
 * @help 此插件不提供插件命令。
 * 此插件在RPG Maker MV和MZ下运行。
 *
 * 此插件使玩家能够移动8个方向
 *
 * [Summary]
...
/*:ja
 * @target MV MZ
 * @plugindesc 播放器可以进行8方向移动，也可以触摸输入移动。
 * @author 神無月サスケ, Yami
 *
 * @param dir4 Switch ID
 * @type number
 ...
 *
 * @help 该插件没有插件命令。
  *该插件与RPG Tsukuru MV和MZ兼容。
  *
  *此插件可让您向8个方向移动。
  *
  *■概述
  *该插件是Yami的Yami_8DIR.js的改进版本。
  *-与触摸面板一起移动时，它也会沿8个方向移动。
  *-如果对角线移动失败，请尽可能直接朝该方向移动。
  *-您可以通过指定开关在8个方向和4个方向之间切换。
